...
BLOG_AUTHOR = "Eduardo Stalinho"  # (translatable)
BLOG_TITLE = "Stack Carioca"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://stackcarioca.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "eduardooc.86@gmail.com"
BLOG_DESCRIPTION = "Lista de projetos Python com ligações com o Rio de Janeiro"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/posts/sobre.html", "Sobre"),
        ("/posts/lista.html", "A Lista"),
    ),
}
